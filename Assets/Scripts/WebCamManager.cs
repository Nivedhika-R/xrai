...
/// <summary>
/// Manages obtaining a render texture from a web cam in Unity.
/// This includes initializing the camera, and converting the camera frames to a RenderTexture.
/// </summary>
public class WebCamManager : MonoBehaviour, ICameraDeviceManager
{
    ...
    {
        // Select the first available or specified web cam
